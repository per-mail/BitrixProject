...
// добавляем страницу "О нас" в навигационную цепочку, $APPLICATION->GetTitle() - задаём заголовок $APPLICATION->GetCurDir()-задаём ссылку
$APPLICATION->AddChainItem($APPLICATION->GetTitle(), $APPLICATION->GetCurDir());

// задаём ключевые слова для страницы
