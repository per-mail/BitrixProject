...
// если форма отправлена и все компоненты совпали
...
// добавляем обязательное поле PHONE
...
// проверка ввёл ли пользователь email
...
// проверка капчи
        ...
        {
// формируется массив из списка полей которые ввёл пользователи
            $arFields = Array(
...
if(empty($arResult["ERROR_MESSAGE"]))
{
// закомментированный код подставляет в форму обратной связи на сайте данные авторизованного пользователя
